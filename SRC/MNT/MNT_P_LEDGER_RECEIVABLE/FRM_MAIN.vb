...
#Region "初期化・終了処理"
    ...
    Private Sub SUB_CTRL_VIEW_INIT()
        ...
        DAT_DATE_TO = FUNC_GET_DATE_LASTMONTH(datSYSTEM_TOTAL_DATE_ACTIVE)
        Call SUB_CONTROL_INITALIZE_DateTimePicker(DTP_DATE_CALC_FROM, srtSYSTEM_TOTAL_CONFIG_SETTINGS.LOCAL.DATE_SYSTEM_REPLACE, DAT_DATE_TO)
        Call SUB_CONTROL_INITALIZE_DateTimePicker(DTP_DATE_CALC_TO, srtSYSTEM_TOTAL_CONFIG_SETTINGS.LOCAL.DATE_SYSTEM_REPLACE, DAT_DATE_TO)

        Call SUB_SYSTEM_COMMBO_MNT_M_SECTION(CMB_CODE_SECTION, True, "全て")
    ...
    Private Sub SUB_CTRL_VALUE_INIT()
        ...
        DAT_FROM = datSYSTEM_TOTAL_DATE_ACTIVE.AddYears(-3)
        ...
        Call SUB_CONTROL_SET_VALUE_DateTimePicker(DTP_DATE_CALC_FROM, DAT_FROM)

        DAT_TO = FUNC_GET_DATE_LASTMONTH(datSYSTEM_TOTAL_DATE_ACTIVE)
        Call SUB_CONTROL_SET_VALUE_DateTimePicker(DTP_DATE_CALC_TO, DAT_TO)

        Call SUB_SET_COMBO_KIND_CODE_FIRST(CMB_CODE_SECTION)
        Call SUB_SET_COMBO_KIND_CODE_FIRST(CMB_FLAG_CONTRACT)
        Call SUB_SET_COMBO_KIND_CODE_FIRST(CMB_KIND_TARGET)
    End Sub
#End Region
...
#Region "実行処理群"
    ...
    Private Sub SUB_PRINT(ByVal BLN_PREVIEW As Boolean, ByVal BLN_PUT_FILE As Boolean)
        ...
        With SRT_CONDITIONS
            ...
            .CODE_MAINTENANCE_FROM = FUNC_VALUE_CONVERT_NUMERIC_INT(TXT_CODE_MAINTENANCE_FROM.Text, CST_SYSTEM_CODE_MAINTENANCE_MIN_VALUE)
            .CODE_MAINTENANCE_TO = FUNC_VALUE_CONVERT_NUMERIC_INT(TXT_CODE_MAINTENANCE_TO.Text, CST_SYSTEM_CODE_MAINTENANCE_MAX_VALUE)
            .DATE_CALC_FROM = DTP_DATE_CALC_FROM.Value
            .DATE_CALC_TO = DTP_DATE_CALC_TO.Value
...
#Region "イベント-テキストチェンジ"
    ...
    Private Sub TXT_CODE_MAINTENANCE_FROM_TextChanged(sender As Object, e As EventArgs) Handles TXT_CODE_MAINTENANCE_FROM.TextChanged
        Call SUB_GET_NAME_MAINTENANCE_INPUT(sender)
    End Sub

    Private Sub TXT_CODE_MAINTENANCE_TO_TextChanged(sender As Object, e As EventArgs) Handles TXT_CODE_MAINTENANCE_TO.TextChanged
        Call SUB_GET_NAME_MAINTENANCE_INPUT(sender)
    End Sub
#End Region
