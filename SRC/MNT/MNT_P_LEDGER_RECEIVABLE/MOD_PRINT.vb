...
#End Region
    ...
    ByRef SRT_DATA As SRT_PRINT_DATA
        ...
        With SRT_CONDITIONS
            ...
            Call SUB_ADD_STR_ROW(STR_ROW, CStr(.CODE_MAINTENANCE_FROM))
            Call SUB_ADD_STR_ROW(STR_ROW, FUNC_GET_MNT_M_MAINTENANCE_NAME_MAINTENANCE(.CODE_MAINTENANCE_FROM, True))
            Call SUB_ADD_STR_ROW(STR_ROW, CStr(.CODE_MAINTENANCE_TO))
            Call SUB_ADD_STR_ROW(STR_ROW, FUNC_GET_MNT_M_MAINTENANCE_NAME_MAINTENANCE(.CODE_MAINTENANCE_TO, True))
        End With
        With SRT_DATA
