...
#Region "初期化・終了処理"
    ...
    Private Sub SUB_CTRL_VIEW_INIT()
        ...
        Call SUB_SYSTEM_COMMBO_MNT_M_KIND(CMB_FLAG_OWNER, ENM_MNT_M_KIND_CODE_FLAG.FLAG_OWNER)
        Call SUB_SYSTEM_COMMBO_MNT_M_KIND(CMB_DAY_FIX_INVOICE, ENM_MNT_M_KIND_CODE_FLAG.DAY_FIX_INVOICE)
    End Sub
    ...
    Private Sub SUB_CTRL_VALUE_INIT()
        ...
        Call SUB_SET_COMBO_KIND_CODE_FIRST(CMB_DAY_FIX_INVOICE)
...
#Region "グリッド関連"
    ...
    Private Sub SUB_REFRESH_GRID()
        ...
        For i = 1 To INT_MAX_INDEX
            With SRT_GRID_DATA_MAIN(i)
                ...
                OBJ_TEMP(ENM_MY_GRID_MAIN.DAY_FIX_INVOICE_NAME) = .DAY_FIX_INVOICE_NAME
    ...
    Private Sub SUB_SET_INDEX_GRID_FROM_KEY(ByVal SRT_KEY As SRT_TABLE_MNT_M_OWNER_KEY)
        Dim INT_INDEX As Integer
    ...
    Private Function FUNC_GET_INDEX_FROM_GRID(ByVal SRT_KEY As SRT_TABLE_MNT_M_OWNER_KEY)
        ...
        For i = 1 To (SRT_GRID_DATA_MAIN.Length - 1)
            With SRT_GRID_DATA_MAIN(i)
                If .CODE_OWNER = SRT_KEY.CODE_OWNER Then
                    Return i
                End If
            End With
        Next
...
#Region "画面状態遷移"
    ...
    Private Sub SUB_REFRESH_ENABLED_ADDRESS()
        ...
        ENM_FLAG_OWNER = FUNC_GET_COMBO_KIND_CODE(CMB_FLAG_OWNER)
        Dim BLN_ENABLED As Boolean
        BLN_ENABLED = (ENM_FLAG_OWNER = ENM_SYSTEM_INDIVIDUAL_FLAG_OWNER.NORMAL)
...
#Region "画面コントロール←→構造体"
    ...
    Private Function FUNC_GET_INPUT_DATA() As SRT_TABLE_MNT_M_OWNER_DATA
        ...
        With SRT_RET
            ...
            .CODE_POST = FUNC_VALUE_CONVERT_NUMERIC(TXT_CODE_POST.Text, 0)
            .NAME_ADDRESS_01 = CStr(TXT_NAME_ADDRESS_01.Text)
            .NAME_ADDRESS_02 = CStr(TXT_NAME_ADDRESS_02.Text)
            .DAY_FIX_INVOICE = FUNC_GET_COMBO_KIND_CODE(CMB_DAY_FIX_INVOICE)
    ...
    Private Sub SUB_SET_INPUT_DATA(ByRef SRT_DATA As SRT_TABLE_MNT_M_OWNER_DATA)
        With SRT_DATA
            ...
            Call SUB_SET_COMBO_KIND_CODE(CMB_FLAG_OWNER, .FLAG_OWNER)
            TXT_CODE_POST.Text = .CODE_POST
            TXT_NAME_ADDRESS_01.Text = .NAME_ADDRESS_01
            TXT_NAME_ADDRESS_02.Text = .NAME_ADDRESS_02
            Call SUB_SET_COMBO_KIND_CODE(CMB_DAY_FIX_INVOICE, .DAY_FIX_INVOICE)
...
#Region "イベント-インデックスチェンジ"
    Private Sub CMB_FLAG_OWNER_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CMB_FLAG_OWNER.SelectedIndexChanged
        Call SUB_REFRESH_ENABLED_ADDRESS()
    End Sub
#End Region
