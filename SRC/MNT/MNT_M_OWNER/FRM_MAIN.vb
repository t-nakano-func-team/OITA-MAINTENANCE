...
#Region "初期化・終了処理"
    ...
    Private Sub SUB_CTRL_VIEW_INIT()
        ...
        Call SUB_SYSTEM_COMMBO_MNT_M_KIND(CMB_FLAG_INVOICE_FIXDAY, ENM_MNT_M_KIND_CODE_FLAG.FLAG_INVOICE_FIXDAY)
    End Sub
    ...
    Private Sub SUB_CTRL_VALUE_INIT()
        ...
        Call SUB_SET_COMBO_KIND_CODE_FIRST(CMB_FLAG_INVOICE_FIXDAY)
...
#Region "画面コントロール←→構造体"
    ...
    Private Function FUNC_GET_INPUT_DATA() As SRT_TABLE_MNT_M_OWNER_DATA
        ...
        With SRT_RET
            ...
            .FLAG_INVOICE_FIXDAY = FUNC_GET_COMBO_KIND_CODE(CMB_FLAG_INVOICE_FIXDAY)
    ...
    Private Sub SUB_SET_INPUT_DATA(ByRef SRT_DATA As SRT_TABLE_MNT_M_OWNER_DATA)
        With SRT_DATA
            ...
            Call SUB_SET_COMBO_KIND_CODE(CMB_FLAG_INVOICE_FIXDAY, .FLAG_INVOICE_FIXDAY)
