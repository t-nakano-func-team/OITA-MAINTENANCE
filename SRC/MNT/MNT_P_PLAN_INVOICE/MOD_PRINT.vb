...
#Region "帳票用・構造体"
    ...
    Public Structure SRT_PRINT_DATA '印刷データ
        ...
        Public Function SORT_INDEX() As Decimal
            ...
            DEC_RET += CDec(Me.CODE_SECTION * (10 ^ CST_FLAG_CONTRACT_MAX_LENGTH) * (10 ^ CST_DATE_MAX_LENGTH) * (10 ^ INT_SYSTEM_NUMBER_CONTRACT_MAX_LENGTH) * (10 ^ INT_SYSTEM_SERIAL_CONTRACT_MAX_LENGTH))
            DEC_RET += CDec(Me.FLAG_CONTRACT * (10 ^ CST_DATE_MAX_LENGTH) * (10 ^ INT_SYSTEM_NUMBER_CONTRACT_MAX_LENGTH) * (10 ^ INT_SYSTEM_SERIAL_CONTRACT_MAX_LENGTH))

            Dim INT_DATE_INVOICE_PLAN As Integer
            INT_DATE_INVOICE_PLAN = FUNC_CONVERT_DATETIME_TO_NUMERIC_DATE(Me.DATE_INVOICE_PLAN)
            DEC_RET += CDec(INT_DATE_INVOICE_PLAN * (10 ^ INT_SYSTEM_NUMBER_CONTRACT_MAX_LENGTH) * (10 ^ INT_SYSTEM_SERIAL_CONTRACT_MAX_LENGTH))
