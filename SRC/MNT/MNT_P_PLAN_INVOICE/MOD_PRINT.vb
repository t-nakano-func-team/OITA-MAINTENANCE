...
#Region "帳票用・構造体"
    ...
    Public Structure SRT_PRINT_DATA '印刷データ
        ...
        Public Function SORT_INDEX() As Decimal
            ...
            DEC_RET += Me.CODE_SECTION * (10 ^ CST_FLAG_CONTRACT_MAX_LENGTH) * (10 ^ CST_DATE_MAX_LENGTH) * (10 ^ INT_SYSTEM_NUMBER_CONTRACT_MAX_LENGTH) * (10 ^ INT_SYSTEM_SERIAL_CONTRACT_MAX_LENGTH)
            Dim INT_FLAG_CONTRACT_SORT As Integer
            INT_FLAG_CONTRACT_SORT = FUNC_GET_FLAG_CONTRACT_SORT_ID(Me.FLAG_CONTRACT)
            DEC_RET += INT_FLAG_CONTRACT_SORT * (10 ^ CST_DATE_MAX_LENGTH) * (10 ^ INT_SYSTEM_NUMBER_CONTRACT_MAX_LENGTH) * (10 ^ INT_SYSTEM_SERIAL_CONTRACT_MAX_LENGTH)
