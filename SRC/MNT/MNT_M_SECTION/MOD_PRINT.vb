...
#Region "帳票用・定数"
    Private Const CST_PRINT_DEFINITION As String = "MNT_M_SECTION" '定義体名称
    Private Const CST_PRINT_LIST_NAME As String = "部署マスタリスト"
...
#End Region
    ...
    Private Function FUNC_GET_SQL(ByRef SRT_CONDITIONS As SRT_PRINT_CONDITIONS) As String
        ...
        With STR_SQL
            ...
            Call .Append("MNT_M_SECTION WITH(NOLOCK)" & System.Environment.NewLine)
    ...
    ByRef SRT_DATA As SRT_PRINT_DATA
        ...
        With SRT_DATA
            ...
            Call SUB_ADD_STR_ROW(STR_ROW, CStr(.NAME_SECTION))
