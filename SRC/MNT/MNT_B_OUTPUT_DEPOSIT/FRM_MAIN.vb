...
#Region "初期化・終了処理"
    ...
    Private Sub SUB_CTRL_VALUE_INIT()
        ...
        LBL_CODE_YYYYMM.Text = Format(INT_CODE_YYYYMM, "0000年00月")

        Dim DAT_DATE_INVOICE As DateTime
        DAT_DATE_INVOICE = FUNC_GET_DATE_INVOICE_MAX()
        LBL_DATE_INVOICE.Text = If(DAT_DATE_INVOICE = cstVB_DATE_MIN, "", Format(DAT_DATE_INVOICE, "yyyy年MM月dd日"))

        Dim DAT_DATE_DEPOSIT As DateTime
        DAT_DATE_DEPOSIT = FUNC_GET_DATE_DEPOSIT_MAX()
        LBL_DATE_DEPOSIT.Text = If(DAT_DATE_DEPOSIT = cstVB_DATE_MIN, "", Format(DAT_DATE_DEPOSIT, "yyyy年MM月dd日"))
    End Sub
#End Region
...
#Region "内部処理"
    Private Function FUNC_GET_DATE_INVOICE_MAX() As DateTime
        ...
        With STR_SQL
            ...
            .Append("MAX(DATE_INVOICE)" & System.Environment.NewLine)
        ...
        DAT_RET = FUNC_SYSTEM_GET_SQL_SINGLE_VALUE_DATETIME(STR_SQL.ToString)

        Return DAT_RET
    End Function

    Private Function FUNC_GET_DATE_DEPOSIT_MAX() As DateTime
        Dim STR_SQL As System.Text.StringBuilder
        STR_SQL = New System.Text.StringBuilder
        With STR_SQL
            .Append("SELECT" & System.Environment.NewLine)
            .Append("MAX(DATE_DEPOSIT)" & System.Environment.NewLine)
            .Append("FROM" & System.Environment.NewLine)
