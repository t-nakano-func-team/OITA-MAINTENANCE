...
#End Region
    ...
    Private Sub SUB_REPLACE_DATA(ByRef SRT_DATA As SRT_PRINT_DATA)
        With SRT_DATA
            .KIND_WORK_NAME = FUNC_GET_MNG_M_KIND_NAME_KIND(ENM_MNT_M_KIND_CODE_FLAG.KIND_WORK, .KIND_WORK)
            .FLAG_INVALID_NAME = FUNC_GET_MNG_M_KIND_NAME_KIND(ENM_MNT_M_KIND_CODE_FLAG.FLAG_INVALID_SHORT, .FLAG_INVALID)
        End With
    End Sub
