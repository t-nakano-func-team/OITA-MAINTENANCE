...
#Region "実行処理群"
    Private Sub SUB_BATCH()
        ...
        RST_MSG = OFD_FILE_OPEN.ShowDialog()
        ...
        STR_MSG = "以下のファイルを取り込みます。" & Environment.NewLine & FUNC_PATH_TO_FILENAME(SRT_CONDITIONS.FILE_PATH_GET) & Environment.NewLine & "よろしいですか？"
        ...
        Call SUB_PUT_PROGRESS_GUIDE("ファイルの取込を行っています。")
        Dim BLN_RET As Boolean
        Dim BLN_PUT As Boolean
        Dim INT_CNT As Integer
        BLN_RET = MOD_BATCH.FUNC_BACTH_MAIN(BLN_PUT, SRT_CONDITIONS, INT_CNT)
        ...
        Call SUB_REFRESH_COUNT_LINK(INT_CNT)
...
#Region "内部処理"
    Private Sub SUB_SET_COUNT_LINK(ByVal INT_CNT As Integer)
        ...
        Call LBL_COUNT_BATCH.Refresh()
    End Sub

    Private Sub SUB_REFRESH_COUNT_LINK(ByVal INT_CNT As Integer)
        Call SUB_SET_COUNT_LINK(INT_CNT)
    End Sub

    Public Sub SUB_PUT_PROGRESS_GUIDE(ByVal strPROGRESS As String)

        LBL_BATCH_PROGRESS.Text = strPROGRESS
