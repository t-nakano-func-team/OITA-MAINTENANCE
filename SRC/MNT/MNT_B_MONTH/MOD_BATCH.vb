...
#End Region
    ...
    Private Function FUNC_GET_NEW_CONTRACT(ByRef SRT_DATA As SRT_TABLE_MNT_T_CONTRACT) As SRT_TABLE_MNT_T_CONTRACT
        ...
        With SRT_RET.DATA
            ...
            .DATE_MAINTENANCE_START = SRT_DATA.DATA.DATE_MAINTENANCE_START
            .DATE_MAINTENANCE_END = SRT_DATA.DATA.DATE_MAINTENANCE_END
            .DATE_INVOICE_BASE = SRT_DATA.DATA.DATE_INVOICE_BASE
