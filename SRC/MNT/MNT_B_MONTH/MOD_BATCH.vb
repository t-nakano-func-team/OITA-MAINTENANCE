...
#End Region
    ...
    Private Function FUNC_GET_NEW_CONTRACT(ByRef SRT_DATA As SRT_TABLE_MNT_T_CONTRACT) As SRT_TABLE_MNT_T_CONTRACT
        ...
        With SRT_RET.DATA
            ...
            .DATE_CONTRACT = FUNC_GET_DATE_CONTRACT(SRT_DATA.DATA.DATE_CONTRACT, SRT_DATA.DATA.DATE_MAINTENANCE_START, SRT_DATA.DATA.DATE_MAINTENANCE_END)
            ...
            .DATE_MAINTENANCE_START = FUNC_GET_DATE_MAINTENANCE_START(SRT_DATA.DATA.DATE_MAINTENANCE_START, SRT_DATA.DATA.DATE_MAINTENANCE_END)
            .DATE_MAINTENANCE_END = FUNC_GET_DATE_MAINTENANCE_END(SRT_DATA.DATA.DATE_MAINTENANCE_START, SRT_DATA.DATA.DATE_MAINTENANCE_END)
    ...
    Private Function FUNC_GET_DATE_CONTRACT(ByVal DAT_DATE_CONTRACT As DateTime, ByVal DAT_DATE_MAINTENANCE_START As DateTime, ByVal DAT_DATE_MAINTENANCE_END As DateTime) As DateTime
        ...
        INT_YYYYMM_MAINTENANCE_END = FUNC_GET_YYYYMM_FROM_DATE(DAT_DATE_MAINTENANCE_END)
        ...
        DAT_RET = FUNC_SYSTEM_INDVIDUAL_ADD_MONTH(DAT_DATE_CONTRACT, 1)
        Return DAT_RET
    End Function
    ...
    Private Function FUNC_GET_DATE_MAINTENANCE_START(ByVal DAT_DATE_MAINTENANCE_START As DateTime, ByVal DAT_DATE_MAINTENANCE_END As DateTime) As DateTime
        ...
        Select Case INT_DEF
            Case 7, 8, 9, 10, 11
                DAT_RET = FUNC_SYSTEM_INDVIDUAL_ADD_MONTH(DAT_DATE_MAINTENANCE_START, 12)
                Return DAT_RET
        End Select

        DAT_RET = FUNC_SYSTEM_INDVIDUAL_ADD_MONTH(DAT_DATE_MAINTENANCE_START, INT_DEF)
        Return DAT_RET
    End Function
    ...
    Private Function FUNC_GET_DATE_MAINTENANCE_END(ByVal DAT_DATE_MAINTENANCE_START As DateTime, ByVal DAT_DATE_MAINTENANCE_END As DateTime) As DateTime
        ...
        Select Case INT_DEF
            Case 7, 8, 9, 10, 11
                DAT_RET = FUNC_SYSTEM_INDVIDUAL_ADD_MONTH(DAT_DATE_MAINTENANCE_END, 12)
                Return DAT_RET
        End Select

        DAT_RET = FUNC_SYSTEM_INDVIDUAL_ADD_MONTH(DAT_DATE_MAINTENANCE_END, INT_DEF)
        Return DAT_RET
    End Function
#Region "内部処理-汎用"
