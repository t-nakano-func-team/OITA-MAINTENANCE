...
#Region "初期化・終了処理"
    ...
    Private Sub SUB_CTRL_VALUE_INIT()
        ...
        DAT_DATE_FROM = datSYSTEM_TOTAL_DATE_ACTIVE.AddYears(-3)
        DAT_DATE_FROM = FUNC_GET_DATE_FIRSMONTH(DAT_DATE_FROM.AddMonths(-1))
        Call SUB_CONTROL_SET_VALUE_DateTimePicker(DTP_DATE_CONTRACT_FROM, DAT_DATE_FROM)
        Dim DAT_DATE_TO As DateTime
        DAT_DATE_TO = datSYSTEM_TOTAL_DATE_ACTIVE '.AddMonths(6)
