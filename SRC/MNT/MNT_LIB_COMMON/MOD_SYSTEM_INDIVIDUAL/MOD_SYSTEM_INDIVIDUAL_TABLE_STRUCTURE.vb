...
Public Module MOD_SYSTEM_INDIVIUAL_TABLE_STRUCTURE_MNT_M_WORK

#Region "モジュール用・定数"
    Private Const CST_TABLE_NAME_DEFAULT As String = "MNT_M_WORK"
#End Region

#Region "KEY"
    Public Structure SRT_TABLE_MNT_M_WORK_KEY
...
#End Region
    ...
    Public Structure SRT_TABLE_MNT_M_WORK
        Public KEY As SRT_TABLE_MNT_M_WORK_KEY
        Public DATA As SRT_TABLE_MNT_M_WORK_DATA
    End Structure

#Region "CASH"
    Private CASH_TABLE() As SRT_TABLE_MNT_M_WORK

    Private Function FUNC_SEARCH_CASH(
    ByRef SRT_CASH() As SRT_TABLE_MNT_M_WORK, ByRef SRT_KEY As SRT_TABLE_MNT_M_WORK_KEY
    ) As Integer
    ...
    Private Sub SUB_ADD_CASH(
    ByRef SRT_CASH() As SRT_TABLE_MNT_M_WORK, ByRef SRT_CASH_ON As SRT_TABLE_MNT_M_WORK
    )
        Dim INT_SERACH As Integer
        INT_SERACH = FUNC_SEARCH_CASH(SRT_CASH, SRT_CASH_ON.KEY)
        If INT_SERACH <> -1 Then
...
#Region "SELECT"
    Public Function FUNC_SELECT_TABLE_MNT_M_WORK(
    ByRef SRT_DATA As SRT_TABLE_MNT_M_WORK_KEY,
    ByRef SRT_RET As SRT_TABLE_MNT_M_WORK_DATA,
    Optional ByVal BLN_CASH As Boolean = False
    ) As Boolean
        ...
        Dim SRT_CASH_ONE As SRT_TABLE_MNT_M_WORK
        SRT_CASH_ONE.KEY = SRT_DATA
        SRT_CASH_ONE.DATA = SRT_RET
...
#Region "DELETE"
    Public Function FUNC_DELETE_TABLE_MNT_M_WORK(
    ByRef SRT_DATA As SRT_TABLE_MNT_M_WORK_KEY
    ) As Boolean
        Dim SRT_SQL As SRT_SQL_TOOL_DELETE
        With SRT_SQL
...
#Region "INSERT"
    Public Function FUNC_INSERT_TABLE_MNT_M_WORK(
    ByRef SRT_DATA As SRT_TABLE_MNT_M_WORK
    ) As Boolean
...
#Region "CHECK"
    Public Function FUNC_CHECK_TABLE_MNT_M_WORK(
    ByRef SRT_DATA As SRT_TABLE_MNT_M_WORK_KEY
    ) As Boolean
...
#Region "CASH"
    ...
    ByRef SRT_CASH() As SRT_TABLE_MNT_M_ACCOUNT, ByRef SRT_KEY As SRT_TABLE_MNT_M_ACCOUNT_KEY
        ...
        For i = LBound(SRT_CASH) To UBound(SRT_CASH)
            With SRT_CASH(i)
                If .KEY.KIND_ACCOUNT = SRT_KEY.KIND_ACCOUNT _
...
#Region "SELECT"
    ...
    Optional ByVal BLN_CASH As Boolean = False
        ...
        With SRT_SQL
            ...
            .COL_NAME = "*"
            ReDim .WHERE(2)
            .WHERE(1).COL_NAME = "KIND_ACCOUNT"
            .WHERE(1).VALUE = SRT_DATA.KIND_ACCOUNT
...
#Region "INSERT"
    ...
    ByRef SRT_DATA As SRT_TABLE_MNT_M_ACCOUNT
        ...
        Call STR_SQL.Append("(" & Environment.NewLine)
        With SRT_DATA.KEY
            Call STR_SQL.Append(FUNC_GET_VALUE_SQL_STRING(.KIND_ACCOUNT) & "," & Environment.NewLine)
...
Public Module MOD_SYSTEM_INDIVIUAL_TABLE_STRUCTURE_MNT_M_HANDLE_WORK

#Region "モジュール用・定数"
    Private Const CST_TABLE_NAME_DEFAULT As String = "MNT_M_HANDLE_WORK"
#End Region

#Region "KEY"
    Public Structure SRT_TABLE_MNT_M_HANDLE_WORK_KEY
...
#End Region
    ...
    Public Structure SRT_TABLE_MNT_M_HANDLE_WORK
        Public KEY As SRT_TABLE_MNT_M_HANDLE_WORK_KEY
        Public DATA As SRT_TABLE_MNT_M_HANDLE_WORK_DATA
    End Structure

#Region "CASH"
    Private CASH_TABLE() As SRT_TABLE_MNT_M_HANDLE_WORK

    Private Function FUNC_SEARCH_CASH(
    ByRef SRT_CASH() As SRT_TABLE_MNT_M_HANDLE_WORK, ByRef SRT_KEY As SRT_TABLE_MNT_M_HANDLE_WORK_KEY
    ) As Integer
        ...
        For i = LBound(SRT_CASH) To UBound(SRT_CASH)
            With SRT_CASH(i)
                If .KEY.CODE_HANDLE = SRT_KEY.CODE_HANDLE Then
                    Return i
                End If
            End With
        Next
    ...
    Private Sub SUB_ADD_CASH(
    ByRef SRT_CASH() As SRT_TABLE_MNT_M_HANDLE_WORK, ByRef SRT_CASH_ON As SRT_TABLE_MNT_M_HANDLE_WORK
    )
        Dim INT_SERACH As Integer
        INT_SERACH = FUNC_SEARCH_CASH(SRT_CASH, SRT_CASH_ON.KEY)
        If INT_SERACH <> -1 Then
...
#Region "SELECT"
    Public Function FUNC_SELECT_TABLE_MNT_M_HANDLE_WORK(
    ByRef SRT_DATA As SRT_TABLE_MNT_M_HANDLE_WORK_KEY,
    ByRef SRT_RET As SRT_TABLE_MNT_M_HANDLE_WORK_DATA,
    Optional ByVal BLN_CASH As Boolean = False
    ) As Boolean
        ...
        With SRT_SQL
            ...
            .COL_NAME = "*"
            ReDim .WHERE(1)
            .WHERE(1).COL_NAME = "CODE_HANDLE"
            .WHERE(1).VALUE = SRT_DATA.CODE_HANDLE
            .ORDER_KEY = ""
        End With
        ...
        Dim SRT_CASH_ONE As SRT_TABLE_MNT_M_HANDLE_WORK
        SRT_CASH_ONE.KEY = SRT_DATA
        SRT_CASH_ONE.DATA = SRT_RET
...
#Region "DELETE"
    Public Function FUNC_DELETE_TABLE_MNT_M_HANDLE_WORK(
    ByRef SRT_DATA As SRT_TABLE_MNT_M_HANDLE_WORK_KEY
    ) As Boolean
        Dim SRT_SQL As SRT_SQL_TOOL_DELETE
        With SRT_SQL
...
#Region "INSERT"
    Public Function FUNC_INSERT_TABLE_MNT_M_HANDLE_WORK(
    ByRef SRT_DATA As SRT_TABLE_MNT_M_HANDLE_WORK
    ) As Boolean
...
#Region "CHECK"
    Public Function FUNC_CHECK_TABLE_MNT_M_HANDLE_WORK(
    ByRef SRT_DATA As SRT_TABLE_MNT_M_HANDLE_WORK_KEY
    ) As Boolean
