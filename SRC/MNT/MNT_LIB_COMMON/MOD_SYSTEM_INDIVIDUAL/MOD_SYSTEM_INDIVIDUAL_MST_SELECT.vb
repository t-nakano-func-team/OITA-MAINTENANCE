...
#End Region
    ...
    Private SRT_CASH_GET_MNT_M_OWNER_DAY_FIX_INVOICE() As SRT_CASH_INT_INT
    Public Function FUNC_GET_MNT_M_OWNER_DAY_FIX_INVOICE(
    ByVal INT_CODE_OWNER As Integer,
    Optional ByVal BLN_CASH As Boolean = False
    ) As Integer

        Dim SRT_MY_CASH() As SRT_CASH_INT_INT
        SRT_MY_CASH = SRT_CASH_GET_MNT_M_OWNER_DAY_FIX_INVOICE
        If BLN_CASH Then
            Dim INT_CASH_INDEX As Integer
            INT_CASH_INDEX = FUNC_SEARCH_CASH_INT_INT(SRT_MY_CASH, INT_CODE_OWNER)
            If INT_CASH_INDEX <> -1 Then
        ...
        Call SUB_ADD_CASH_INT_INT(SRT_CASH_GET_MNT_M_OWNER_DAY_FIX_INVOICE, INT_CODE_OWNER, INT_RET)
...
#End Region
    ...
    Optional ByVal BLN_CASH As Boolean = False
        ...
        If BLN_CASH Then
            Dim INT_CASH_INDEX As Integer
            INT_CASH_INDEX = FUNC_SEARCH_CASH_INT_INT_STR(SRT_MY_CASH, ENM_FLAG_ACCOUNT, INT_CODE_KIND)
            If INT_CASH_INDEX <> -1 Then
                Return SRT_MY_CASH(INT_CASH_INDEX).VALUE
            End If
        End If
        ...
        Call SUB_ADD_CASH_INT_INT_STR(SRT_CASH_GET_MNT_M_ACCOUNT_NAME_KIND, ENM_FLAG_ACCOUNT, INT_CODE_KIND, STR_RET)
...
Public Module MOD_SYSTEM_INDIVIDUAL_MST_SELECT_MNT_M_HANDLE_WORK

#Region "モジュール用・定数"
    Private Const CST_TABLE_NAME_DEFAULT As String = "MNT_M_HANDLE_WORK"
#End Region

    Private SRT_CASH_GET_MNT_M_HANDLE_WORK_KIND_WORK() As SRT_CASH_INT_INT
    Public Function FUNC_GET_MNT_M_HANDLE_WORK_KIND_WORK(
    ByVal INT_CODE_HANDLE As Integer,
    Optional ByVal BLN_CASH As Boolean = False
    ) As Integer

        Dim SRT_MY_CASH() As SRT_CASH_INT_INT
        SRT_MY_CASH = SRT_CASH_GET_MNT_M_HANDLE_WORK_KIND_WORK
        If BLN_CASH Then
            Dim INT_CASH_INDEX As Integer
            INT_CASH_INDEX = FUNC_SEARCH_CASH_INT_INT(SRT_MY_CASH, INT_CODE_HANDLE)
            If INT_CASH_INDEX <> -1 Then
                Return SRT_MY_CASH(INT_CASH_INDEX).VALUE
            End If
        End If
        ...
        Call SUB_ADD_CASH_INT_INT(SRT_CASH_GET_MNT_M_HANDLE_WORK_KIND_WORK, INT_CODE_HANDLE, INT_RET)

        Return INT_RET
    End Function

    Private SRT_CASH_GET_MNT_M_HANDLE_WORK_CODE_SECTION() As SRT_CASH_INT_INT
    Public Function FUNC_GET_MNT_M_HANDLE_WORK_CODE_SECTION(
    ByVal INT_CODE_HANDLE As Integer,
    Optional ByVal BLN_CASH As Boolean = False
    ) As Integer

        Dim SRT_MY_CASH() As SRT_CASH_INT_INT
        SRT_MY_CASH = SRT_CASH_GET_MNT_M_HANDLE_WORK_CODE_SECTION
        If BLN_CASH Then
            Dim INT_CASH_INDEX As Integer
            INT_CASH_INDEX = FUNC_SEARCH_CASH_INT_INT(SRT_MY_CASH, INT_CODE_HANDLE)
            If INT_CASH_INDEX <> -1 Then
        ...
        Call SUB_ADD_CASH_INT_INT(SRT_CASH_GET_MNT_M_HANDLE_WORK_CODE_SECTION, INT_CODE_HANDLE, INT_RET)
...
#End Region
    ...
    Private SRT_CASH_GET_MNT_M_MAINTENANCE_KIND_WORK() As SRT_CASH_INT_INT
    Public Function FUNC_GET_MNT_M_MAINTENANCE_KIND_WORK(
    ByVal INT_CODE_WORK As Integer,
    Optional ByVal BLN_CASH As Boolean = False
    ) As Integer

        Dim SRT_MY_CASH() As SRT_CASH_INT_INT
        SRT_MY_CASH = SRT_CASH_GET_MNT_M_MAINTENANCE_KIND_WORK
        If BLN_CASH Then
            Dim INT_CASH_INDEX As Integer
            INT_CASH_INDEX = FUNC_SEARCH_CASH_INT_INT(SRT_MY_CASH, INT_CODE_WORK)
            If INT_CASH_INDEX <> -1 Then
                Return SRT_MY_CASH(INT_CASH_INDEX).VALUE
            End If
        End If
        ...
        Call SUB_ADD_CASH_INT_INT(SRT_CASH_GET_MNT_M_MAINTENANCE_KIND_WORK, INT_CODE_WORK, INT_RET)

        Return INT_RET
    End Function

    Private SRT_CASH_GET_MNT_M_MAINTENANCE_NAME_WORK() As SRT_CASH_INT_STR
    Public Function FUNC_GET_MNT_M_MAINTENANCE_NAME_WORK(
    ByVal INT_CODE_WORK As Integer,
    Optional ByVal BLN_CASH As Boolean = False
    ) As String

        Dim SRT_MY_CASH() As SRT_CASH_INT_STR
        SRT_MY_CASH = SRT_CASH_GET_MNT_M_MAINTENANCE_NAME_WORK
        If BLN_CASH Then
            Dim INT_CASH_INDEX As Integer
        ...
        Call SUB_ADD_CASH_INT_STR(SRT_CASH_GET_MNT_M_MAINTENANCE_NAME_WORK, INT_CODE_WORK, STR_RET)
