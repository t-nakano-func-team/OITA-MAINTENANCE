...
#End Region
    ...
    Optional ByVal BLN_CASH As Boolean = False
        ...
        If BLN_CASH Then
            Dim INT_CASH_INDEX As Integer
            INT_CASH_INDEX = FUNC_SEARCH_CASH_INT_INT_STR(SRT_MY_CASH, ENM_KIND_ACCOUNT, INT_CODE_KIND)
            If INT_CASH_INDEX <> -1 Then
                Return SRT_MY_CASH(INT_CASH_INDEX).VALUE
            End If
        End If
        ...
        With SRT_SQL
            ...
            .WHERE(1).VALUE = CInt(ENM_KIND_ACCOUNT.GetHashCode)
            .WHERE(2).COL_NAME = "CODE_KIND"
            .WHERE(2).VALUE = INT_CODE_KIND
            .ORDER_KEY = ""
        End With
        ...
        Call SUB_ADD_CASH_INT_INT_STR(SRT_CASH_GET_MNT_M_ACCOUNT_NAME_KIND, ENM_KIND_ACCOUNT, INT_CODE_KIND, STR_RET)
...
Public Module MOD_SYSTEM_INDIVIDUAL_MST_SELECT_MNT_M_WORK

#Region "モジュール用・定数"
    Private Const CST_TABLE_NAME_DEFAULT As String = "MNT_M_WORK"
#End Region

    Private SRT_CASH_GET_MNT_M_WORK_KIND_WORK() As SRT_CASH_INT_INT
    Public Function FUNC_GET_MNT_M_WORK_KIND_WORK(
    ByVal INT_CODE_WORK As Integer,
    Optional ByVal BLN_CASH As Boolean = False
    ) As Integer

        Dim SRT_MY_CASH() As SRT_CASH_INT_INT
        SRT_MY_CASH = SRT_CASH_GET_MNT_M_WORK_KIND_WORK
        If BLN_CASH Then
            Dim INT_CASH_INDEX As Integer
        ...
        Call SUB_ADD_CASH_INT_INT(SRT_CASH_GET_MNT_M_WORK_KIND_WORK, INT_CODE_WORK, INT_RET)
