...
#End Region
    ...
    Private SRT_CASH_GET_MNT_M_HANDLE_WORK_FLAG_WORK() As SRT_CASH_INT_INT
    Public Function FUNC_GET_MNT_M_HANDLE_WORK_FLAG_WORK(
    ByVal INT_CODE_HANDLE As Integer,
    Optional ByVal BLN_CASH As Boolean = False
    ) As Integer

        Dim SRT_MY_CASH() As SRT_CASH_INT_INT
        SRT_MY_CASH = SRT_CASH_GET_MNT_M_HANDLE_WORK_FLAG_WORK
        If BLN_CASH Then
            Dim INT_CASH_INDEX As Integer
        ...
        Call SUB_ADD_CASH_INT_INT(SRT_CASH_GET_MNT_M_HANDLE_WORK_FLAG_WORK, INT_CODE_HANDLE, INT_RET)
