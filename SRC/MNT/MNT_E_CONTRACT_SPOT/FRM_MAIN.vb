...
#Region "画面コントロール←→構造体"
    ...
    Private Function FUNC_GET_INPUT_DATA() As SRT_TABLE_MNT_T_CONTRACT_DATA
        ...
        With SRT_RET
            .FLAG_CONTRACT = ENM_SYSTEM_INDIVIDUAL_FLAG_CONTRACT.SPOT
            ...
            .FLAG_INVOICE_METHOD = ENM_SYSTEM_INDIVIDUAL_FLAG_INVOICE_METHOD.NONE
            ...
            .FLAG_CONTINUE = ENM_SYSTEM_INDIVIDUAL_FLAG_CONTINUE.NO_CONTINUE
...
#Region "画面状態遷移"
    ...
    Private Sub SUB_REFRESH_ENABLD_EXT_SPOT()
        ...
        Dim ENM_FLAG_OWNER As ENM_SYSTEM_INDIVIDUAL_FLAG_OWNER
        ENM_FLAG_OWNER = FUNC_GET_MNT_M_OWNER_FLAG_OWNER(INT_CODE_OWNER, True)

        Dim BLN_EANBLED As Boolean
        Select Case ENM_FLAG_OWNER
            Case ENM_SYSTEM_INDIVIDUAL_FLAG_OWNER.NORMAL
                BLN_EANBLED = False
            Case ENM_SYSTEM_INDIVIDUAL_FLAG_OWNER.SPOT
                BLN_EANBLED = True
            Case Else
                BLN_EANBLED = False
        End Select
...
#Region "チェック処理"
    Private Function FUNC_CHECK_INPUT_KEY() As Boolean
        ...
        SRT_DATA = Nothing
        Call FUNC_SELECT_TABLE_MNT_T_CONTRACT(SRT_KEY, SRT_DATA)
        If Not (SRT_DATA.FLAG_CONTRACT = ENM_SYSTEM_INDIVIDUAL_FLAG_CONTRACT.SPOT) Then
            Dim STR_NAME_KIND As String
            STR_NAME_KIND = FUNC_GET_MNT_M_KIND_NAME_KIND(ENM_MNT_M_KIND_CODE_FLAG.FLAG_CONTRACT, ENM_SYSTEM_INDIVIDUAL_FLAG_CONTRACT.SPOT)
            STR_ERR_MSG = ""
...
#Region "その他処理"
    ...
    Private Sub SUB_REFRESH_DATE_INVOICE_BASE_VALUE()
        ...
        If DTP_DATE_MAINTENANCE_END.Value > DTP_DATE_CONTRACT.Value Then
            DAT_DATE_CALC_BASE = DTP_DATE_MAINTENANCE_END.Value
        Else
            DAT_DATE_CALC_BASE = DTP_DATE_CONTRACT.Value
        End If
        ...
        Select Case ENM_KIND_FIX_DATE
            ...
            Case Else
                If CInt(ENM_KIND_FIX_DATE) < DAT_DATE_CALC_BASE.Day Then
