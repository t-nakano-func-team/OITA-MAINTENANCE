...
#Region "初期化・終了処理"
    ...
    Private Sub SUB_CTRL_VIEW_INIT()
        ...
        Call SUB_SYSTEM_COMMBO_MNT_M_HANDLE_WORK(CMB_CODE_HANDLE)
    ...
    Private Sub SUB_CTRL_VALUE_INIT()
        ...
        Call SUB_SET_COMBO_KIND_CODE_FIRST(CMB_CODE_HANDLE)
...
#Region "画面コントロール←→構造体"
    ...
    Private Function FUNC_GET_INPUT_DATA() As SRT_TABLE_MNT_T_CONTRACT_DATA
        ...
        With SRT_RET
            ...
            .CODE_HANDLE = FUNC_GET_COMBO_KIND_CODE(CMB_CODE_HANDLE)
    ...
    Private Sub SUB_SET_INPUT_DATA(ByRef SRT_DATA As SRT_TABLE_MNT_T_CONTRACT_DATA)
        ...
        With SRT_DATA
            ...
            Call SUB_SET_COMBO_KIND_CODE(CMB_CODE_HANDLE, .CODE_HANDLE)
            Call SUB_REFRESH_CODE_SECTION()
            Call SUB_REFRESH_KIND_WORK()
...
#Region "画面状態遷移"
    ...
    Private Sub SUB_REFRESH_ENABLD_EXT_SPOT()
        ...
        Else
            ...
            TXT_CODE_POST.Text = FUNC_GET_MNT_M_OWNER_CODE_POST(INT_CODE_OWNER)
...
#Region "その他処理"
    ...
    Private Sub SUB_REFRESH_KIND_WORK()
        Dim INT_CODE_HANDLE As Integer
        INT_CODE_HANDLE = FUNC_GET_COMBO_KIND_CODE(CMB_CODE_HANDLE)

        Dim INT_KIND_WORK As Integer
        INT_KIND_WORK = FUNC_GET_MNT_M_HANDLE_WORK_KIND_WORK(INT_CODE_HANDLE, True)
        Call SUB_SET_COMBO_KIND_CODE(CMB_KIND_WORK, INT_KIND_WORK)
    End Sub

    Private Sub SUB_REFRESH_CODE_SECTION()
        Dim INT_CODE_HANDLE As Integer
        INT_CODE_HANDLE = FUNC_GET_COMBO_KIND_CODE(CMB_CODE_HANDLE)

        Dim INT_CODE_SECTION As Integer
        INT_CODE_SECTION = FUNC_GET_MNT_M_HANDLE_WORK_CODE_SECTION(INT_CODE_HANDLE, True)

        Dim STR_NAME_SECTION As String
        STR_NAME_SECTION = FUNC_GET_MNT_M_KIND_NAME_KIND(ENM_MNT_M_KIND_CODE_FLAG.CODE_SECTION, INT_CODE_SECTION)
        LBL_CODE_SECTION_NAME.Text = STR_NAME_SECTION
    End Sub
...
#Region "イベント-インデックスチェンジ"
    Private Sub CMB_CODE_HANDLE_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CMB_CODE_HANDLE.SelectedIndexChanged
        Call SUB_REFRESH_CODE_SECTION()
        Call SUB_REFRESH_KIND_WORK()
    End Sub
