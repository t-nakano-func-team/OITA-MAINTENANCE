...
#Region "その他処理"
    ...
    Private Sub SUB_REFRESH_DATE_INVOICE_BASE_VALUE()
        ...
        Dim ENM_KIND_FIX_DATE As ENM_SYSTEM_INDIVIDUAL_DAY_FIX_INVOICE
        ENM_KIND_FIX_DATE = FUNC_GET_MNT_M_OWNER_DAY_FIX_INVOICE(INT_CODE_OWNER, True)
        If ENM_KIND_FIX_DATE <= 0 Then
            ENM_KIND_FIX_DATE = ENM_SYSTEM_INDIVIDUAL_DAY_FIX_INVOICE.FIX_LAST
        End If
        ...
        DAT_DATE_CALC_BASE = DTP_DATE_MAINTENANCE_END.Value 'FUNC_GET_DATE_FIRSMONTH(DAT_DATE_MAINTENANCE_START.AddMonths(1))

        Dim DAT_SET As DateTime
        Select Case ENM_KIND_FIX_DATE
            Case ENM_SYSTEM_INDIVIDUAL_DAY_FIX_INVOICE.FIX_10, ENM_SYSTEM_INDIVIDUAL_DAY_FIX_INVOICE.FIX_20, ENM_SYSTEM_INDIVIDUAL_DAY_FIX_INVOICE.FIX_25
                ...
                End If
            Case ENM_SYSTEM_INDIVIDUAL_DAY_FIX_INVOICE.FIX_LAST
