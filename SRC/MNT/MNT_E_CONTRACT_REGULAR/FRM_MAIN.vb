...
#Region "画面用・列挙定数"
    Private Enum ENM_MY_EXEC_DO
        ...
        DO_SHOW_INVOICE_CHECK
        DO_SHOW_DEPOSIT_CHECK
        DO_SHOW_SETTING
        DO_SHOW_COMMANDLINE
...
#Region "初期化・終了処理"
    ...
    Private Sub SUB_CTRL_VIEW_INIT()
        ...
        DAT_DATE_INPUT_MAX = datSYSTEM_TOTAL_DATE_ACTIVE.AddYears(4)
...
#Region "各処理呼出元"
    ...
    ByVal ENM_EXEC_DO As ENM_MY_EXEC_DO
        ...
        Select Case ENM_EXEC_DO
            ...
            Case ENM_MY_EXEC_DO.DO_SHOW_INVOICE_CHECK
                Call SUB_SHOW_INVOICE_CHECK()
            Case ENM_MY_EXEC_DO.DO_SHOW_DEPOSIT_CHECK
                Call SUB_SHOW_DEPOSIT_CHECK()
...
#End Region
    ...
    Private Sub SUB_SHOW_INVOICE_CHECK()
        ...
        Dim FRM_SHOW As FRM_SUB_02
        FRM_SHOW = New FRM_SUB_02
        FRM_SHOW.Font = New System.Drawing.Font(FRM_SHOW.Font.Name, Me.Font.Size)
        FRM_SHOW.Text = Me.Text & " " & "既存請求確認"
        FRM_SHOW.NUMBER_CONTRACT = CInt(TXT_NUMBER_CONTRACT.Text)
        FRM_SHOW.SERIAL_CONTRACT = CInt(TXT_SERIAL_CONTRACT.Text)
    ...
    Private Sub SUB_SHOW_DEPOSIT_CHECK()
        ...
        Dim FRM_SHOW As FRM_SUB_03
        FRM_SHOW = New FRM_SUB_03
        FRM_SHOW.Font = New System.Drawing.Font(FRM_SHOW.Font.Name, Me.Font.Size)
        FRM_SHOW.Text = Me.Text & " " & "既存入金確認"
        FRM_SHOW.NUMBER_CONTRACT = CInt(TXT_NUMBER_CONTRACT.Text)
        FRM_SHOW.SERIAL_CONTRACT = CInt(TXT_SERIAL_CONTRACT.Text)
...
#Region "チェック処理"
    ...
    Private Function FUNC_CHECK_INPUT_DATA() As Boolean
        ...
        Dim ENM_FLAG_INVALID As ENM_SYSTEM_INDIVIDUAL_FLAG_INVALID
        ENM_FLAG_INVALID = FUNC_GET_MNT_M_OWNER_FLAG_INVALID(INT_CODE_OWNER, True)
        If ENM_FLAG_INVALID = ENM_SYSTEM_INDIVIDUAL_FLAG_INVALID.DELETE Then
            STR_ERR_MSG = FUNC_GET_INPUT_CHECK_ERROR_MESSAGE(ENM_SYSTEM_INDIVIDUAL_INPUT_CHECK.CHK_ERR_DISABLED, FUNC_GET_TEXT_GUIDE_LABEL(CTL_CONTROL))
            Call MessageBox.Show(STR_ERR_MSG, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Call CTL_CONTROL.Focus()
            Return False
        End If
...
#Region "その他処理"
    ...
    Private Sub SUB_REFRESH_DATE_INVOICE_BASE_VALUE()
        ...
        DAT_DATE_CALC_BASE = FUNC_GET_DATE_FIRSMONTH(DAT_DATE_MAINTENANCE_START) '作業開始月にそのまま請求
        Dim DAT_SET As DateTime
...
#Region "イベント-ダブルクリック"
    Private Sub LBL_COUNT_INVOICE_ALREADY_DoubleClick(sender As Object, e As EventArgs) Handles LBL_COUNT_INVOICE_ALREADY.DoubleClick
        Call SUB_EXEC_DO(ENM_MY_EXEC_DO.DO_SHOW_INVOICE_CHECK)
    End Sub

    Private Sub LBL_COUNT_DEPOSIT_ALREADY_DoubleClick(sender As Object, e As EventArgs) Handles LBL_COUNT_DEPOSIT_ALREADY.DoubleClick
        Call SUB_EXEC_DO(ENM_MY_EXEC_DO.DO_SHOW_DEPOSIT_CHECK)
    End Sub
#End Region
