...
Partial Class FRM_SUB_03
    ...
    Private Sub InitializeComponent()
        ...
        Me.LBL_COUNT_DEPOSIT_ALREADY.TabIndex = 11
        ...
        Me.LBL_COUNT_DEPOSIT_GUIDE.Text = "既入金回数"
