...
#Region "初期化・終了処理"
    ...
    Private Sub SUB_CTRL_VIEW_INIT()
        ...
        Call SUB_DGV_COLUMN_WIDTH_INIT_COUNT_FONT(DGV_VIEW_DATA, "1,3,5,5,6", "CLRLR")
...
#Region "グリッド関連"
    Private Sub SUB_MAKE_GRID_DATA(ByVal SRT_CONDITIONS As SRT_SEARCH_CONDITIONS)
        ...
        With STR_SQL
            ...
            Call .Append("KIND_CONTRACT DESC,YEAR_INVOICE,MONTH_INVOICE,CODE_OWNER,NUMBER_LIST_INVOICE,NUMBER_CONTRACT,SERIAL_CONTRACT,SERIAL_INVOICE" & Environment.NewLine)
        End With
    ...
    Private Function FUNC_GET_GRID_INVOICE() As SRT_PTINT_INVOICE_KEY()

        Dim SRT_RET() As SRT_PTINT_INVOICE_KEY
        ReDim SRT_RET(0)
