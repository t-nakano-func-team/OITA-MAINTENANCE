...
#End Region
    ...
    Private Sub SUB_REPLACE_DATA(ByRef SRT_DATA As SRT_PRINT_DATA)
        With SRT_DATA
            ...
            .DATE_WORK_FROM_INT = FUNC_CONVERT_DATETIME_TO_NUMERIC_DATE(.DATE_WORK_FROM)
            .DATE_WORK_TO_INT = FUNC_CONVERT_DATETIME_TO_NUMERIC_DATE(.DATE_WORK_TO)
    ...
    ByRef SRT_DATA As SRT_PRINT_DATA
        ...
        With SRT_DATA
            ...
            Call SUB_ADD_STR_ROW(STR_ROW, CStr(.DATE_WORK_FROM_INT))
            Call SUB_ADD_STR_ROW(STR_ROW, CStr(.DATE_WORK_TO_INT))
