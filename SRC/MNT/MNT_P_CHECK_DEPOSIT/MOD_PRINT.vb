...
#End Region
    ...
    Private Sub SUB_REPLACE_DATA(ByRef SRT_DATA As SRT_PRINT_DATA)
        With SRT_DATA
            ...
            .KIND_DEPOSIT_NAME = FUNC_GET_MNT_M_ACCOUNT_NAME_ACCOUNT(ENM_SYSTEM_INDIVIDUAL_KIND_ACCOUNT.KIND_DEPOSIT, .KIND_DEPOSIT)
            .KIND_DEPOSIT_SUB_NAME = FUNC_GET_MNT_M_ACCOUNT_NAME_ACCOUNT(ENM_SYSTEM_INDIVIDUAL_KIND_ACCOUNT.KIND_PAYEE, .KIND_DEPOSIT_SUB)
            If .KIND_COST <= 0 Then
                .KIND_COST_NAME = ""
            Else
                .KIND_COST_NAME = FUNC_GET_MNT_M_ACCOUNT_NAME_ACCOUNT(ENM_SYSTEM_INDIVIDUAL_KIND_ACCOUNT.KIND_COST, .KIND_COST)
            End If
        End With
    End Sub
