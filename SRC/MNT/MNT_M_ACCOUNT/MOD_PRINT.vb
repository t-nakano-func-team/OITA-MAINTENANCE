...
#Region "帳票用・定数"
    Private Const CST_PRINT_DEFINITION As String = "MNT_M_ACCOUNT" '定義体名称
    Private Const CST_PRINT_LIST_NAME As String = "勘定科目マスタリスト"
...
#End Region
    ...
    Private Function FUNC_GET_SQL(ByRef SRT_CONDITIONS As SRT_PRINT_CONDITIONS) As String
        ...
        With STR_SQL
            ...
            Call .Append("MNT_M_ACCOUNT WITH(NOLOCK)" & System.Environment.NewLine)
