...
#Region "グリッド関連"
    ...
    Private Sub SUB_SET_INDEX_GRID_FROM_KEY(ByVal SRT_KEY As SRT_TABLE_JM_M_CUSTOMER_KEY)
        Dim INT_INDEX As Integer
    ...
    Private Function FUNC_GET_INDEX_FROM_GRID(ByVal SRT_KEY As SRT_TABLE_JM_M_CUSTOMER_KEY)
...
#Region "画面コントロール←→構造体"
    Private Function FUNC_GET_INPUT_KEY() As SRT_TABLE_JM_M_CUSTOMER_KEY
    ...
    Private Function FUNC_GET_INPUT_DATA() As SRT_TABLE_JM_M_CUSTOMER_DATA
        Dim SRT_RET As SRT_TABLE_JM_M_CUSTOMER_DATA

        With SRT_RET
            .NAME_CUSTOMER = CStr(TXT_NAME_CUSTOMER.Text)
    ...
    Private Sub SUB_SET_INPUT_DATA(ByRef SRT_DATA As SRT_TABLE_JM_M_CUSTOMER_DATA)
        With SRT_DATA
            TXT_NAME_CUSTOMER.Text = .NAME_CUSTOMER
            LBL_FLAG_INVALID.Text = FUNC_GET_JM_M_KIND_NAME_KIND(ENM_JM_M_KIND_CODE_FLAG.FLAG_INVALID, .FLAG_INVALID)
        End With
    End Sub
#End Region
