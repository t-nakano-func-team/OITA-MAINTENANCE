...
#Region "JM_T_CUSTOMER_CON"
Public Module MOD_SYSTEM_INDIVIUAL_TABLE_STRUCTURE_JM_T_CUSTOMER_CON

#Region "モジュール用・定数"
    Private Const CST_TABLE_NAME_DEFAULT As String = "JM_T_CUSTOMER_CON"
#End Region

#Region "KEY"
    Public Structure SRT_TABLE_JM_T_CUSTOMER_CON_KEY
        Public NUMBER_USER As Integer
        Public CODE_CUSTOMER As Integer
...
#End Region
    ...
    Public Structure SRT_TABLE_JM_T_CUSTOMER_CON
        Public KEY As SRT_TABLE_JM_T_CUSTOMER_CON_KEY
        Public DATA As SRT_TABLE_JM_T_CUSTOMER_CON_DATA
    End Structure

#Region "CASH"
    Private CASH_TABLE() As SRT_TABLE_JM_T_CUSTOMER_CON

    Private Function FUNC_SEARCH_CASH(
    ByRef SRT_CASH() As SRT_TABLE_JM_T_CUSTOMER_CON, ByRef SRT_KEY As SRT_TABLE_JM_T_CUSTOMER_CON_KEY
    ) As Integer
        ...
        For i = LBound(SRT_CASH) To UBound(SRT_CASH)
            With SRT_CASH(i)
                If .KEY.NUMBER_USER = SRT_KEY.NUMBER_USER _
                    And .KEY.CODE_CUSTOMER = SRT_KEY.CODE_CUSTOMER _
                    And .KEY.CODE_CUSTOMER_SUB = SRT_KEY.CODE_CUSTOMER_SUB Then
                    Return i
                End If
            End With
        Next
    ...
    Private Sub SUB_ADD_CASH(
    ByRef SRT_CASH() As SRT_TABLE_JM_T_CUSTOMER_CON, ByRef SRT_CASH_ON As SRT_TABLE_JM_T_CUSTOMER_CON
    )
        Dim INT_SERACH As Integer
        INT_SERACH = FUNC_SEARCH_CASH(SRT_CASH, SRT_CASH_ON.KEY)
        If INT_SERACH <> -1 Then
...
#Region "SELECT"
    Public Function FUNC_SELECT_TABLE_JM_T_CUSTOMER_CON(
    ByRef SRT_DATA As SRT_TABLE_JM_T_CUSTOMER_CON_KEY,
    ByRef SRT_RET As SRT_TABLE_JM_T_CUSTOMER_CON_DATA,
    Optional ByVal BLN_CASH As Boolean = False
    ) As Boolean
        ...
        With SRT_SQL
            ...
            .WHERE(2).COL_NAME = "CODE_CUSTOMER"
            .WHERE(2).VALUE = SRT_DATA.CODE_CUSTOMER
            .WHERE(3).COL_NAME = "CODE_CUSTOMER_SUB"
            .WHERE(3).VALUE = SRT_DATA.CODE_CUSTOMER_SUB
            .ORDER_KEY = ""
        End With
        ...
        Dim SRT_CASH_ONE As SRT_TABLE_JM_T_CUSTOMER_CON
        SRT_CASH_ONE.KEY = SRT_DATA
        SRT_CASH_ONE.DATA = SRT_RET
...
#Region "DELETE"
    Public Function FUNC_DELETE_TABLE_JM_T_CUSTOMER_CON(
    ByRef SRT_DATA As SRT_TABLE_JM_T_CUSTOMER_CON_KEY
    ) As Boolean
        Dim SRT_SQL As SRT_SQL_TOOL_DELETE
        With SRT_SQL
...
#Region "INSERT"
    Public Function FUNC_INSERT_TABLE_JM_T_CUSTOMER_CON(
    ByRef SRT_DATA As SRT_TABLE_JM_T_CUSTOMER_CON
    ) As Boolean
        ...
        With SRT_DATA.KEY
            Call STR_SQL.Append(FUNC_GET_VALUE_SQL_STRING(.NUMBER_USER) & "," & Environment.NewLine)
            Call STR_SQL.Append(FUNC_GET_VALUE_SQL_STRING(.CODE_CUSTOMER) & "," & Environment.NewLine)
            Call STR_SQL.Append(FUNC_GET_VALUE_SQL_STRING(.CODE_CUSTOMER_SUB) & "," & Environment.NewLine)
        End With
        With SRT_DATA.DATA
            Call STR_SQL.Append(FUNC_GET_VALUE_SQL_STRING(.CODE_CONNECTION) & "" & Environment.NewLine)
        End With
        Call STR_SQL.Append(")" & Environment.NewLine)
...
#Region "CHECK"
    Public Function FUNC_CHECK_TABLE_JM_T_CUSTOMER_CON(
    ByRef SRT_DATA As SRT_TABLE_JM_T_CUSTOMER_CON_KEY
    ) As Boolean
