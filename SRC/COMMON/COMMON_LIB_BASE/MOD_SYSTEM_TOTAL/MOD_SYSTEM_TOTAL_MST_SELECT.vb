...
Public Module MOD_SYSTEM_TOTAL_MST_SELECT_MNG_M_VALUE

#Region "モジュール用・定数"
    Private Const CST_TABLE_NAME_DEFAULT As String = "MNG_M_VALUE"
#End Region

    Private SRT_CASH_GET_MNG_M_VALUE_VALUE_KIND() As SRT_CASH_INT_INT_DEC
    Public Function FUNC_GET_MNG_M_VALUE_VALUE_KIND(
    ByVal ENM_CODE_FLAG As ENM_MNG_M_KIND_CODE_FLAG,
    ByVal INT_CODE_KIND As Integer,
    Optional ByVal BLN_CASH As Boolean = False
    ) As Decimal

        Dim SRT_MY_CASH() As SRT_CASH_INT_INT_DEC
        SRT_MY_CASH = SRT_CASH_GET_MNG_M_VALUE_VALUE_KIND
        If BLN_CASH Then
            Dim INT_CASH_INDEX As Integer
            INT_CASH_INDEX = FUNC_SEARCH_CASH_INT_INT_DEC(SRT_MY_CASH, ENM_CODE_FLAG, INT_CODE_KIND)
        ...
        DEC_RET = FUNC_SYSTEM_GET_SQL_SINGLE_VALUE_DECIMAL(STR_SQL, 0.00)

        Call SUB_ADD_CASH_INT_INT_DEC(SRT_CASH_GET_MNG_M_VALUE_VALUE_KIND, ENM_CODE_FLAG, INT_CODE_KIND, DEC_RET)
